...
<div id="eo_admin_tab_<?php echo $slug; ?>" class="eo_admin_tab">
    ...
    <div id="eo_admin_content_<?php echo $slug; ?>" class="eo_admin_tab_content eo_no_padding">
        ...
        ?>
            ...
            <form id="eo_admin_settings_form" method="post" action="<?php echo get_admin_url(). 'admin.php?page=eonet&eo_tab=settings' ?>" class="eo_form">
                    ...
                    <ul class="eo_nav_tabs" role="tablist">
                        ...
                        foreach ($extensions_array as $extension_slug=>$extension) : ?>
                            ...
                            <li class="<?php echo $active; ?>" >
                                <a href="#eo_tab_<?php echo $extension_slug; ?>" data-eo-slug="<?php echo $extension_slug; ?>"><?php echo $extension['name']; ?></a>
                            </li>
                            <?php $count++; ?>
                        <?php endforeach; ?>
                    ...
                    <div class="eo_tab_content">
                        ...
                        foreach ($extensions_array as $extension_slug=>$extension) : ?>
                            ...
                            if(!empty($component_settings)) : ?>
                                <div class="eo_tab_pane <?php echo $active; ?>" id="eo_tab_<?php echo $extension_slug; ?>">
                                    ...
                                    <div class="eo_tab_inner_content">
                                        <div class="eonet_padding">
                                            <div class="eo_alert eo_alert_info">
                                                <h4><?php _e('No option available at this moment... ','eonet-frontend-publisher'); ?></h4>
                                                <p><?php _e('We\'re still working on this component options. Feel free to get in touch with us for any option idea. Options will be coming in the premium version.', 'eonet-frontend-publisher'); ?></p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="eo_tab_inner_footer">
                ...
                <a href="javascript:void(0);" id="eo_admin_settings_reset_trigger" class="eo_btn eo_btn_default">
                    <?php _e('Reset Settings', 'eonet-frontend-publisher'); ?>
                </a>
                ...
                (function ($) {
	                ...
	                setTimeout(function(){
	                    var data = {
		                    ...
		                    message = "<?php _e("Are you sure? This can't be undone. All your Eonet settings will be erased.",'eonet-frontend-publisher') ?>";;
